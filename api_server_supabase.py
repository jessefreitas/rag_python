...
# -*- coding: utf-8 -*-
"""
Servidor API Específico para Extensão Chrome - Supabase Real
Porta 5002 para evitar conflitos
"""
...
def health_check():
    ...
    return jsonify({
        'status': 'ok',
        'message': 'RAG Python Extension API v1.5.1',
...
if __name__ == '__main__':
    print("🚀 RAG Python - Servidor de API para Extensão Chrome")
    print("=" * 60)
    print("🔌 Iniciando servidor na porta 5002...")
